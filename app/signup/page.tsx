...
export default function SignupPage() {
  const { signup, authMessage, clearAuthMessage, sessionUser} = useArticula();
    ...
    <div className="min-h-screen flex items-center justify-center px-4 relative overflow-hidden">
      ...
      <div className="w-full max-w-md">
        ...
        <div className="bg-card border border-border rounded-3xl p-8 shadow-2xl shadow-black/30">
          ...
          {/* Google Button */}
          {/* <button onClick={()=>login()} className="w-full flex items-center justify-center gap-3 h-11 rounded-xl border border-border bg-secondary/50 hover:bg-secondary text-sm font-medium transition-colors mb-6">
